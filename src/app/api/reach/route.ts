...
export async function POST(req: Request) {
  let body: { city?: string; from?: [number, number]; maxMin?: number; maxOutdoorMin?: number | null; mobility?: boolean; walkOnly?: boolean; speed?: number; hourBucket?: string; blockedStations?: string[] };
  ...
  const r = reach(loadGraph(cityOf(body.city).id), {
